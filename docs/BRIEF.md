...
I would like to make an ESP32 backed project that reads a card scan from an RDM630 and moves a servo based on some logic.
  ...
  The RDM and servo should draw independent power from the battery, which should come in on microUSB.  An existing RDM can plug into the board we are making.
